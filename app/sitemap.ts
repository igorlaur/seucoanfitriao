...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/coanfitriao-sao-paulo`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    ...
    { url: `${base}/blog/consultoria-airbnb-sao-paulo`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
